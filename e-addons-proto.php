...
add_action('e_addons/loaded', function() {
    ...
    $plugin = new \EAddonsProto\Plugin();
});
add_action('plugins_loaded', function() {
    if (!function_exists('e_addons_load_plugin')) {
        add_action('admin_notices', function() {
            $message = __('You need to activate "Elementor Free" and "e-addons Free" in order to use "e-addons PROTO" plugin.', 'elementor');
